...
export const ValueBox = ({ valueKey, value, suffix, title, idealRange, colourRange, valueRange, widthClass = ' w-32 ', decimal = 0, onClick }: ValueBoxProps) => {
  ...
  return (
    <div onClick={onClick} className="cursor-pointer">
      <div className={`flex flex-col ${widthClass} border-2 border-light-grey rounded-lg pl-1 pr-2 `}>
        ...
        <div className={`text-center text-2xl font-semibold my-1 ${selectColor(value)}`}>{value?.toFixed(decimal)}{suffix}</div>
