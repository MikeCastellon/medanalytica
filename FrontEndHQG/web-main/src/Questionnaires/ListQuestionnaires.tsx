...
export const ListQuestionnaires = () => {
  ...
  return (
      ...
      <div className="flex flex-col justify-between h-44 gradient-background items-start p-4">
        ...
        <div className="flex-row">
          ...
          <p className="text-white text-lg">
            Questionnaires are composed of one or more questionsets, you can
            complete an entire questionnaire or individual question sets
          </p>
        </div>
      </div>
                ...
                return (
                  <div key={i} className="  flex-1 rounded-lg shadow-md ">
                    ...
                    <div className="py-4">
                      ...
                      <div className=" flex flex-row flex-wrap justify-end gap-2 px-4 mt-4 ">
                        <div className="">
                          <Link to={`${q.id}/fill`}>
                            <div className="group relative flex flex-col justify-center items-center border-2 border-primary-grey rounded-full h-10 w-10 text-primary-grey hover:border-primary-green hover:text-primary-green">
                              ...
                              <span className="group-hover:opacity-100 transition-opacity w-12 bg-gray-800 px-1 text-sm text-gray-100 rounded-md absolute left-1/2 -translate-x-1/2 translate-y-full opacity-0 m-4 mx-auto cursor-pointer ">
                                {"Fill-in"}
                              </span>
                            </div>
                          </Link>
                          ...
                          <button
                            onClick={() => {
                              navigator.clipboard.writeText(
                                ...
                                }/${subjectId}/questionnaires/questionnaires/${
                                  q.id
                                }`
                              );
                              setCopied(true);
    ...
    -translate-x-1/2 translate-y-full opacity-0 m-4 mx-auto cursor-pointer">Comming Soon <br />Email questions to to this patient to complete at a later stage</span>
