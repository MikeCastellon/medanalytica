...
const CHAVITA_TEXTS = {
  1: 'Chavita 1 — Root Chakra: The first energy center in the lower pelvis connects a person to the ground through the legs, just as it stands emotionally for grounding and independence. A disturbed first Chakra is associated with insufficient grounding, disrupted self-confidence, identity problems and a lack of basic trust.',
  2: 'Chavita 2 — Sacral Chakra: The second Chakra has to do with the realization of one\'s own interests in a social context. Should one fight or flee, invest more or less energy to attain one\'s goals? Whoever does not know this becomes restless and disoriented, fights things out convulsively or compensates weakness with a show of strength.',
  3: 'Chavita 3 — Solar Plexus Chakra: The third Chakra has to do with becoming sated and satisfied by absorbing the outside world; one is nourished materially and emotionally from outside and thereby satisfied. One takes what one needs, asserting one\'s will and getting one\'s way. When the third Chakra is disturbed, it leads to aggression inhibition and frustration. One withdraws from the outside world and constantly wants more than one gets.',
  4: 'Chavita 4 — Heart Chakra: The heart represents the energetic center of the "Self", an emotional core of individual perception and personal development, having to do with loving trust, mental power and playful-spontaneous self-realization. When the heart center is disturbed, it leads to a feeling of total retreat, of being captive, and of crippling and (over the longer term) strenuous lack of orientation, behind which are concealed great fears of being hurt or completely destroyed.',
  5: 'Chavita 5 — Throat Chakra: The neck, as control center in the confrontation between reason and emotion, rational and irrational, duty and desire, has, as an energy center, two conflicts which are, from a content standpoint, quite contrary. If the confrontation tends toward the rational pole, then a conflict forms with an overexcited hyperactivity; if it tends toward the emotional pole, it gives rise to a conflict with a great inner emptiness and rigidity.',
  6: 'Chavita 6 — Third Eye Chakra: In the sixth energy Center, a person\'s individual needs are coordinated with the outside world. As in the second Chakra, this involves a complex regulatory system and, ultimately, the "fight or flight" decision. When this harmonious equilibrium breaks down, it gives rise to the typical conflicts of the sixth Chakra: restlessness, tension, discomfort, timidity, egotism or, as compensation, subservience.',
  7: 'Chavita 7 — Crown Chakra: The seventh Chakra presents a very accurate portrayal of the world, depicting one\'s own place in the world sensibly and true to scale. Via this energy center, the content of attitudes and feelings are properly balanced out, so that everything is realistically represented. Disturbances of the seventh Chakra lead to misperceptions of reality in the form of imaginary and unreal idealizations, and unacknowledged pain that the world is much worse than one had thought. Acquisitiveness and mistrust are typical emotions of the seventh Chakra.',
};

const EMVITA_TEXTS = {
  1: 'Emvita 1 — Independence: A feeling of "not being good enough", feelings of inferiority, disrupted basic trust, often puberty conflicts. One feels not good enough, has identity problems. Primary emotional orientation, in the sense of sufficient self-confidence is lacking. Basic trust has been lost or was never there. A frequent tendency to melancholy.',
  2: 'Emvita 2 — Lack of Concentration: Easily distracted, unable to concentrate, unfocused, daydreaming. One has difficulty staying focused and centered. The mind wanders easily and one is constantly distracted. There is a lack of grounding that makes sustained mental effort difficult.',
  3: 'Emvita 3 — At the Mercy of, Helpless: Weak-willed, helpless as a child, bedwetting, encopresis, incontinence. One feels helpless and in every way paralyzed. The stronger the demands, the more unable one feels to arrive at any kind of solution. Life is experienced as a never-ending struggle. One tends to lethargy and immobility, has the tendency to dither, be undecided, play for time, leave things up in the air, postpone everything to the last minute or, in the extreme case, give up altogether.',
  4: 'Emvita 4 — Extremely Self-Controlled: Numbness, suppression of joie de vivre, exaggerated sense of duty and responsibility. One does not allow oneself to grow and live one\'s own life. One was held back from the normal childhood joy of expansion and was possibly too rigidly disciplined. Only compulsion, rationality and good behavior have top priority. One is afraid of yielding to spontaneity, freedom and joy in life, because this is associated with great danger to oneself and others.',
  5: 'Emvita 5 — Hectic, Nervous: Hectic, hyperkinetic symptoms, upset, nervous, driven and restless. Nervousness and drivenness, upset and restless. High physical tension with a tendency to react with physical symptoms to inner stress. One engages in hypernormal activity, is ambitious and often hyperactive. Tendency to obsessive perfection. One believes in only having a right to live by pushing oneself to peak performance.',
  6: 'Emvita 6 — Perseverance: Wanting to be self-controlled and show no weakness despite a feeling of helplessness; tendency to express anxiety through physical symptoms. One tries to maintain control and show no weakness despite deep helplessness. The perseverance pattern masks underlying fear and vulnerability with stoic endurance.',
  7: 'Emvita 7 — Show of Strength, Stubborn: Goes beyond one\'s limits; always showing strength despite secretly feeling inferior; obstinate, arrogant, cocky. One\'s actual existence does not match up with one\'s self-image. Secretly, one feels uncertain and inferior, but conceals it behind a facade of strong self-confidence. There is a constant alternation between feelings of strength and weakness.',
  8: 'Emvita 8 — Isolated: Joyless, feeling abandoned, unhappy, self-pitying. Emotionally, one lives on an island, surrounded by strangers. One would like to make contact but cannot get close to the others. One feels isolated, like an outcast. One lacks the capability to communicate with others in a satisfactory manner. The resulting feeling of isolation leads to inner paralysis and lethargy.',
  9: 'Emvita 9 — Pent-up Emotions: Extremely pent-up destructive rage, all too ready to conform and sacrifice, in the extreme sudden outbursts of rage. One tries to win the sympathy and affection of others with an especially pleasant and obliging personality. One constantly adapts oneself to the needs of others. In the process, one denies one\'s own goals, which leads to subliminal resentment and, in time, to a mountain of unfulfilled desires.',
  10: 'Emvita 10 — Wanting More: Insatiable due to a nagging feeling of dissatisfaction and greed, constantly dissatisfied, driven, overly aggressive. Due to a nagging feeling of dissatisfaction and a lack of happy feelings, one constantly wants more out of life. At bottom, one feels desperately poor and needy. What one has or has achieved is never enough.',
  11: 'Emvita 11 — Craving Good Feelings: Deeply dissatisfied, frustrated, profoundly unhappy, in the extreme addiction, anorexia, bulimia. One is deeply dissatisfied and empty. The feeling of constant emotional hunger develops into unreal fantasies and a nagging feeling of drivenness. Sometimes tendency to addiction and dependencies of various kinds.',
  12: 'Emvita 12 — Mental Overexertion: Because trust is disrupted, constant thoughts of problems and failure; difficulty gathering one\'s thoughts. One thinks that an effort of will can bring all moods and emotions under control. One overburdens oneself constantly. Thoughts of problems or failure predominate, and there is a lack of trust in oneself and others.',
  13: 'Emvita 13 — Withdrawn, Deeply Injured: Gutshot, deeply injured and withdrawn, uninterested, self-involved. One feels deeply offended and believes that one can never again get over a severe injury and offense. One withdraws anxiously from other people because one expects nothing good to come of it. One begins to put up walls around one\'s tender soul.',
  14: 'Emvita 14 — Introverted, Compulsive: Cramped and tense; fear of going crazy; difficulty breathing; feeling of isolation behind walls of hopelessness. One has isolated oneself from the outside world and feels trapped behind walls, hopeless. One\'s thoughts go around in circles. The suffocating feeling can be felt physically, emotionally or mentally.',
  15: 'Emvita 15 — Apprehensive: Eerie-frightful, abandoned, extremely anxious, phobias, woebegone and full of sorrow. One feels abandoned and extremely anxious. The world feels eerie and frightful. Phobias and deep sorrow dominate the emotional landscape.',
  16: 'Emvita 16 — Panic: My heart is breaking, as if overrun by a dreadful huge wave, panic attacks, fear of death. One feels overwhelmed by an overpowering fear of death like a gigantic tidal wave. One cannot put up any resistance whatsoever to this powerful fear, but rather feels totally paralyzed. It feels like the final hour has come.',
  17: 'Emvita 17 — Emotional Emptiness: Empty of thoughts and feelings, no initiative, indifferent, emotional emptiness, uncaring, emotions feel frozen. The neck, the "gateway to feelings", can choke off rising emotions in such a manner as to bring about a condition of complete emotional rigidity. One is then completely dominated and guided by the head, as if nothing really affected one anymore. Many patients with this conflict feel a great inner emptiness that can have a very depressive feeling-tone.',
  18: 'Emvita 18 — Rushed: Impulsive, overexcited, stuttering; the feeling of living a life that is false at its core; thoughts outrunning actions. In the neck region strong impulses and drives can build up like a torrent, so that a frightened feeling rises up and one feels literally overrun. Those affected suffer from not being able to make themselves clearly understood.',
  19: 'Emvita 19 — Timid, Faint-hearted: Not wanting to see things clearly, diplomatic, undecided, poor decision-making ability; fear of making a mistake. The actual underlying causes of indecisiveness are the fear of making mistakes and the hope that there might be a better option.',
  20: 'Emvita 20 — Self-sufficient: Narcissistic, self-absorbed, egotistical, mood swings. One views the outside world exclusively as an extension of oneself. One\'s self-satisfaction can degenerate into narcissism. Deep inside, one is unsure of oneself and feels unloved, which one tries to compensate with exaggerated self-love.',
  21: 'Emvita 21 — Physical Overexertion: Restlessly tense; sympathicotonically overdriven, irritable; unable to relax; physically restless, constantly overburdened. One feels rushed and exhausted because one is overstressed. One constantly exceeds one\'s limits to a harmful degree. Way down deep, one feels unloved and worthless.',
  22: 'Emvita 22 — Restless, Mentally Hyperactive: Constant worry without letup, mental nervousness, restlessness due to constant drivenness and a torrent of thoughts. Thoughts whirl nonstop through one\'s head, leading to a condition of inner unrest and drivenness. One has a constant feeling of uncertainty and great worrying.',
  23: 'Emvita 23 — Tense: Completely tensed up, helpless, impulsive, thoughts race ahead of actions, tics, inner tension due to high demands on oneself. One feels constantly tensed up and incapable of relaxing. The emotional background of the tension is due to an overly strict Superego. The tension is actually based on a fear of making mistakes.',
  24: 'Emvita 24 — Uneasiness, Discomfort: Disturbing malaise on the somatic level, hopelessness, depressive tendency. One feels unwell in one\'s own body, as if having to wear the wrong clothing, uncomfortable and annoying. The prevailing mood varies from hopelessness all the way to distinct depression.',
  25: 'Emvita 25 — Mistrust: Withdrawn, grim, unwilling to give, lack of basic trust, obstinate, questioning everything. Because of disappointing experiences, one believes that other people basically have it in for one. One imagines oneself surrounded by a hostile environment. Inside, one refuses to open oneself up emotionally.',
  26: 'Emvita 26 — Materialistic: Wanting everything for oneself, acquisitiveness, miserliness, sees life as a permanent struggle for survival. People with this conflict often have a great fear of change. They find it very difficult to let go of things and modes of behavior. One is constantly seeking and, way down deep, not really satisfied.',
  27: 'Emvita 27 — Unwilling to Face Reality: Imagining things; incapable of clear sensory perception; flight into dream worlds because reality is felt to be intolerable. One cannot tolerate reality and therefore removes it from perception. Underlying this are emotional misery and intolerable frustration which generate a gloomy and joyless fundamental feeling-tone.',
  28: 'Emvita 28 — Wrong Thinking: Obsessive, exaggerated mental fantasies, false dogmas and overly rigid beliefs, deep-seated self-esteem problems. The basic problem of wrong thinking is based on the refusal to acknowledge reality as such. One tends to think dogmatically and is preoccupied with particular convictions.',
};
